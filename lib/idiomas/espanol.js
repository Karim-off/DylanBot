...
//AVISOS DE MENSAJE
const smsAvisoRG = () => { return `*[🛑 Information 🛑]*\n\n` }
const smsAvisoAG = () => { return `*[🛑  information 🛑]*\n\n` }
const smsAvisoIIG = () => { return `*[🛑 information 🛑]*\n\n` }
const smsAvisoFG = () => { return `*[🛑 information 🛑]*\n\n` }
const smsAvisoMG = () => { return `*[🛑 information 🛑]*\n\n` }
const smsAvisoEEG = () => { return `*[🛑 información 🛑]*\n\n` }
const smsAvisoEG = () => { return `*[🛑 information 🛑]*\n\n` }
...
//main.js
const smsWelcome = () => { return '*[Grupos]*\n\n*Te damos la bienvenida @user 👋🏼*'}
const smsBye = () => { return '*[Grupos]*\n\n*Se fue @user espero no vuelvas 🐻‍❄️*'}
