...
m.reply(`╭━━━[ 𝐃𝐲𝐥𝐚𝐧𝐂𝐨𝐢𝐧𝐬 ]━━━⬣\n┃\n┃ღ *PARA:*\n┃ღ ${text}\n┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈\n┃ღ *SE LE AÑADIÓ*\n┃ღ *${gatacoins} 𝐃𝐲𝐥𝐚𝐧𝐂𝐨𝐢𝐧𝐬* 🐈\n┃\n╰━━━━━━━━━━━━━━⬣\n\n${wm}`)}
/*conn.sendHydrated(m.chat, `╭━━━[ 𝘿𝙔𝙇𝘼𝙉𝘾𝙊𝙄𝙉𝙎 🐈 ]━━━⬣\n┃\n┃ღ *PARA | FOR:*\n┃ღ *${text}*\n┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈\n┃ღ *SE LE AÑADIÓ | NOW YOU HAVE*\n┃ღ *${gatacoins} DylanCoin(s)* 🐈\n┃\n╰━━━━━━━━━━━━━━⬣`, wm, null, md, '𝘿𝙮𝙡𝙖𝙣𝘽𝙤𝙩-𝙈𝘿', null, null, [
['💗 𝙈𝙚𝙣𝙪 𝘼𝙫𝙚𝙣𝙩𝙪𝙧𝙖 | 𝙍𝙋𝙂 💗', '.rpgmenu'],
['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́ | 𝘽𝙖𝙘𝙠 𝙩𝙤 𝙈𝙚𝙣𝙪 ☘️', '/menu']], m)
}*/ 
handler.help = ['addgb <@user>']
handler.tags = ['gatacoins']
handler.command = ['añadirdylamcoins', 'añadirdylan', 'añadircoins', 'dardylancoins', 'dargata', 'darcoins'] 
handler.group = true
handler.rowner = true
