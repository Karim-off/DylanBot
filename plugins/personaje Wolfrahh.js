...
let texto = `*ESTE ES WOLFRAHH ✅DB*`
let texto = `_*Habilidad especial: tras cada eliminación o espectador de tu partida, recibes menos daño por disparos en cabeza, y al mismo tiempo, aumentas el daño de tus tiros a la cabeza de los enemigos. Habilidad pasiva.*_`
