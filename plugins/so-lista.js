...
let vn = 'https://a.uguu.se/grbxyGnd.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
let vn = 'https://a.uguu.se/LpSLJMYN.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
let vn = 'https://a.uguu.se/FnkOjomp.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (chat.audios && m.text.match(/(delivery|delivery de empanada|empanada)/gi)) {
let vn = 'https://a.uguu.se/cCVZdSWq.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(putos|tarado|tarado eh|tarado|🤬|🤨)/gi)) {
let vn = 'https://a.uguu.se/QcEXvZvT.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(Bardo|pateo|bardo|🤺|callarte|negro|puto)/gi)) {
let vn = 'https://a.uguu.se/JoAaCXBy.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(saliste del grupo|saliste)/gi)) {
let vn = 'https://a.uguu.se/CxKbpsiS.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(Internet gratis|quiere tener internet gratis)/gi)) {
let vn = 'https://a.uguu.se/gEveJHsg.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
let vn = 'https://a.uguu.se/BbinYvaO.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(goo|temazo|fua temon)/gi)) {    
let vn = 'https://a.uguu.se/TjVPTbat.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
