...
mobile: MethodMobile, 
browser: opcion == '1' ? ['DokiBot', 'Edge', '2.0.0'] : methodCodeQR ? ['DokiBot', 'Edge', '2.0.0'] : ['Chrome (Linux)', '', ''],
auth: {
creds: state.creds,
...
conn.welcome = '-------------------------------------------------\n𝐃𝐘𝐋𝐀𝐍 𝐁𝐎𝐓🗣️\n│📌•Hola👻:@user\n│▢𝙱𝙸𝙴𝙽𝚅𝙴𝙽𝙸𝙳@ 👨🏼‍🔧\n│▢🐼𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝘿𝙀 𝙈𝙄 𝘾𝙍𝙀𝘼𝘿𝙊𝙍 ⚡\n│▢📌•http://wa.me/59176181985\n│▢📚𝙀𝙉 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊 𝙋𝙊𝘿𝙍𝘼𝙎 𝙀𝙉𝘾𝙊𝙉𝙏𝙍𝘼𝙍 👀\n│▢🥵𝙋𝙐𝙏𝘼𝙎 😼\n│▢🤝𝘼𝙈𝙄𝙂𝙓𝙎 🍀\n│▢👹𝙋𝙀𝙇𝙀𝘼𝙎 🗣️\n│▢🤖𝙐𝙉 𝘽𝙊𝙏 𝙎𝙀𝙓𝙔 𝙔 𝙈𝘼𝙎 🥵\n│▢𝙎𝙄 𝘿𝙀𝙎𝙀𝘼𝙎 𝙎𝘼𝘽𝙀𝙍 𝙀𝙇 𝙈𝙀𝙉𝙐 𝘿𝙀𝙇 𝘽𝙊𝙏 (𝘾𝙊𝙈𝘼𝙉𝘿𝙊↓)\n𝗲𝘀𝗰𝗿𝗶𝗯𝗶𝗿 𝗲𝗹 𝗰𝗼𝗺𝗮𝗻𝗱𝗼 #menú\n-----------------------------------------------------\n@desc\n🌱𝐃𝐲𝐥𝐚𝐧-𝐁𝐨𝐭\n-------------------------------------------------'
conn.bye = '-------------------------------------------------\n@user\n𝐒𝐚𝐥𝐢𝐨 𝐃𝐞𝐥 𝐆𝐫𝐮𝐩𝐨 𝐍𝐢𝐦𝐨𝐝𝐨 𝐐𝐮𝐞 𝐓𝐞 𝐕𝐚𝐲𝐚 𝐁𝐢𝐞𝐧. 𝐍𝐨𝐬 𝐡𝐢𝐜𝐢𝐬𝐭𝐞 𝐔𝐧 𝐜𝐮𝐩𝐨 𝐁𝐨𝐭 𝐀𝐝𝐢𝐨𝐬🌱\n\n-------------------------------------------------'
